# -*- coding: utf-8 -*-
"""
First steps in GUI application using PyQt5 classes (QLabel, QPixmap, etc.).

Created on Sat Nov 14 10:45:05 2020
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        label1.setFixedWidth(200) # fixing the width of the label
        label1.move(10, 10)        
        # Label 2: Rich text
